...
class TestSubvolumeSnapshotClones(TestVolumesHelper):
    ...
    def test_subvolume_snapshot_clone_pool_layout_preserve_namespace(self):
        ...
        # schedule a clone into a new pool, preserving the source's namespace
        self._fs_cmd("subvolume", "snapshot", "clone", self.volname, subvolume, snapshot, clone,
                     "--pool_layout", new_pool, "--preserve-namespace")
        ...
        # verify clone
        source_namespace = f'fsvolumens___nogroup_{subvolume}'
        self._verify_clone(subvolume, snapshot, clone, clone_pool=new_pool, clone_pool_namespace=source_namespace)
    ...
    def test_subvolume_snapshot_clone_preserve_namespace_from_non_isolated_source(self):
        ...
        # schedule a clone into a new pool with --preserve-namespace; harmless
        # no-op since the source never had a namespace to preserve
        self._fs_cmd("subvolume", "snapshot", "clone", self.volname, subvolume, snapshot, clone,
                     "--pool_layout", new_pool, "--preserve-namespace")
        ...
        # verify clone
        self._verify_clone(subvolume, snapshot, clone, clone_pool=new_pool, clone_pool_namespace="")
